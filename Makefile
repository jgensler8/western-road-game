...
SCENES_GENERATED = gen_scene_inn.c gen_scene_customers.c gen_scene_intro.c gen_scene_shack.c gen_scene_blue_house.c gen_scene_bandit.c
SCENES_CORE = scene_title.c road_sprite.c scene_road.c scene_shop.c scene_options.c scene_trader.c scene_road_fork.c
SCENES = $(addprefix src/,$(SCENES_CORE)) $(addprefix src/gen/scene/,$(SCENES_GENERATED))
SONGS = none.c road.c trader.c bandit.c
SRCS_CORE = data.c text.c input.c sound.c animate.c items.c
SRCS = $(addprefix src/,$(SRCS_CORE)) $(addprefix src/gen/png2asset/,$(ASSETS)) $(addprefix src/,$(CHARACTERS)) $(addprefix src/,$(ROAD_SPRITES)) $(addprefix src/songs/,$(SONGS)) $(METASPRITE_FIX_SOURCE) $(SCENES)
